...
var ListService_1 = require("../services/ContactListService/ListService");
var CreateService_1 = require("../services/ContactListService/CreateService");
var ShowService_1 = require("../services/ContactListService/ShowService");
var UpdateService_1 = require("../services/ContactListService/UpdateService");
var DeleteService_1 = require("../services/ContactListService/DeleteService");
var FindService_1 = require("../services/ContactListService/FindService");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                record = _a.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(companyId, "-mainchannel")).emit("company-".concat(companyId, "-ContactList"), {
                    action: "create",
                    record: record
                });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(companyId, "-mainchannel")).emit("company-".concat(companyId, "-ContactListItem-").concat(+id), {
                    action: "reload",
                    records: response
                });
