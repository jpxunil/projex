...
var ListService_1 = require("../services/QuickMessageService/ListService");
var CreateService_1 = require("../services/QuickMessageService/CreateService");
var ShowService_1 = require("../services/QuickMessageService/ShowService");
var UpdateService_1 = require("../services/QuickMessageService/UpdateService");
var DeleteService_1 = require("../services/QuickMessageService/DeleteService");
var FindService_1 = require("../services/QuickMessageService/FindService");
...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, searchParam, pageNumber, userId, companyId, _b, records, count, hasMore;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.query, searchParam = _a.searchParam, pageNumber = _a.pageNumber, userId = _a.userId;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                record = _a.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(companyId, "-mainchannel")).emit("company-".concat(companyId, "-quickmessage"), {
                    action: "create",
                    record: record
                });
...
var mediaUpload = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, files, file, quickmessage, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
...
var deleteMedia = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                quickmessage = _a.sent();
                filePath = path_1.default.resolve("public", "quickMessage", quickmessage.mediaName);
