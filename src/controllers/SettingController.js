...
var UpdateSettingService_1 = require("../services/SettingServices/UpdateSettingService");
var ListSettingsService_1 = require("../services/SettingServices/ListSettingsService");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                setting = _a.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(companyId, "-mainchannel")).emit("company-".concat(companyId, "-settings"), {
                    action: "update",
                    setting: setting
                });
