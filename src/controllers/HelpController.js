...
var ListService_1 = require("../services/HelpServices/ListService");
var CreateService_1 = require("../services/HelpServices/CreateService");
var ShowService_1 = require("../services/HelpServices/ShowService");
var UpdateService_1 = require("../services/HelpServices/UpdateService");
var DeleteService_1 = require("../services/HelpServices/DeleteService");
var FindService_1 = require("../services/HelpServices/FindService");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                record = _a.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(companyId, "-mainchannel")).emit("company-".concat(companyId, "-help"), {
                    action: "create",
                    record: record
                });
