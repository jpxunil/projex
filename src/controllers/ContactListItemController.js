...
var ListService_1 = require("../services/ContactListItemService/ListService");
var CreateService_1 = require("../services/ContactListItemService/CreateService");
var ShowService_1 = require("../services/ContactListItemService/ShowService");
var UpdateService_1 = require("../services/ContactListItemService/UpdateService");
var DeleteService_1 = require("../services/ContactListItemService/DeleteService");
var FindService_1 = require("../services/ContactListItemService/FindService");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                record = _a.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(companyId, "-mainchannel")).emit("company-".concat(companyId, "-ContactListItem"), {
                    action: "create",
                    record: record
                });
