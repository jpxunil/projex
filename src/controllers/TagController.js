...
var CreateService_1 = require("../services/TagServices/CreateService");
var ListService_1 = require("../services/TagServices/ListService");
var UpdateService_1 = require("../services/TagServices/UpdateService");
var ShowService_1 = require("../services/TagServices/ShowService");
var DeleteService_1 = require("../services/TagServices/DeleteService");
var SimpleListService_1 = require("../services/TagServices/SimpleListService");
var SyncTagsService_1 = require("../services/TagServices/SyncTagsService");
var KanbanListService_1 = require("../services/TagServices/KanbanListService");
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, pageNumber, searchParam, companyId, _b, tags, count, hasMore;
...
var store = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, color, kanban, companyId, tag, io;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, color = _a.color, kanban = _a.kanban;
                companyId = req.user.companyId;
            ...
            case 1:
                tag = _b.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(companyId, "-mainchannel")).emit("tag", {
                    action: "create",
                    tag: tag
                });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                tagId = req.params.tagId;
                tagData = req.body;
                return [4 /*yield*/, (0, UpdateService_1.default)({ tagData: tagData, id: tagId })];
            case 1:
                tag = _a.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(req.user.companyId, "-mainchannel")).emit("tag", {
                    action: "update",
                    tag: tag
                });
                return [2 /*return*/, res.status(200).json(tag)];
...
var remove = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                tagId = req.params.tagId;
                return [4 /*yield*/, (0, DeleteService_1.default)(tagId)];
            case 1:
                _a.sent();
                io = (0, socket_1.getIO)();
                io.to("company-".concat(req.user.companyId, "-mainchannel")).emit("tag", {
...
var list = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var searchParam, companyId, tags;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
