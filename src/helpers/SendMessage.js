...
var GetWhatsappWbot_1 = require("./GetWhatsappWbot");
var fs_1 = require("fs");
var SendWhatsAppMedia_1 = require("../services/WbotServices/SendWhatsAppMedia");
var SendMessage = function (whatsapp, messageData) { return __awaiter(void 0, void 0, void 0, function () {
    var wbot, chatId, message, options, body, body, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                message = void 0;
                if (!messageData.mediaPath) return [3 /*break*/, 5];
                return [4 /*yield*/, (0, SendWhatsAppMedia_1.getMessageOptions)(messageData.fileName, messageData.mediaPath, messageData.body)];
            case 2:
                options = _a.sent();
