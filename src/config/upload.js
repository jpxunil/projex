    ...
    storage: multer_1.default.diskStorage({
        destination: function (req, file, cb) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, typeArch, fileId, folder;
                return __generator(this, function (_b) {
                    _a = req.body, typeArch = _a.typeArch, fileId = _a.fileId;
                    ...
                    return [2 /*return*/, cb(null, folder)];
                });
            });
        },
        filename: function (req, file, cb) {
            var typeArch = req.body.typeArch;
            var fileName = typeArch && typeArch !== "announcements" ? file.originalname.replace('/', '-').replace(/ /g, "_") : new Date().getTime() + '_' + file.originalname.replace('/', '-').replace(/ /g, "_");
