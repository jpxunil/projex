...
var ContactList = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "ContactLists" })];
    ...
    var ContactList = _classThis = /** @class */ (function (_super) {
        __extends(ContactList_1, _super);
        function ContactList_1() {
            ...
            _this.createdAt = (__runInitializers(_this, _name_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
            ...
            _this.contacts = (__runInitializers(_this, _company_extraInitializers), __runInitializers(_this, _contacts_initializers, void 0));
            __runInitializers(_this, _contacts_extraInitializers);
            return _this;
        }
        return ContactList_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ContactList");
    (function () {
        var _a;
        ...
        _contacts_decorators = [(0, sequelize_typescript_1.HasMany)(function () { return ContactListItem_1.default; }, {
                onUpdate: "CASCADE",
                onDelete: "CASCADE",
                hooks: true
            })];
        ...
        ContactList = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ContactList = _classThis;
}();
