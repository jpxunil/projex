...
var Invoices = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "Invoices" })];
    ...
    var Invoices = _classThis = /** @class */ (function (_super) {
        __extends(Invoices_1, _super);
        function Invoices_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.id = __runInitializers(_this, _id_initializers, void 0);
            _this.detail = (__runInitializers(_this, _id_extraInitializers), __runInitializers(_this, _detail_initializers, void 0));
            _this.status = (__runInitializers(_this, _detail_extraInitializers), __runInitializers(_this, _status_initializers, void 0));
            _this.value = (__runInitializers(_this, _status_extraInitializers), __runInitializers(_this, _value_initializers, void 0));
            ...
            _this.dueDate = (__runInitializers(_this, _updatedAt_extraInitializers), __runInitializers(_this, _dueDate_initializers, void 0));
            _this.companyId = (__runInitializers(_this, _dueDate_extraInitializers), __runInitializers(_this, _companyId_initializers, void 0));
            __runInitializers(_this, _companyId_extraInitializers);
            return _this;
        }
        return Invoices_1;
    }(_classSuper));
    __setFunctionName(_classThis, "Invoices");
    (function () {
        var _a;
        ...
        _detail_decorators = [sequelize_typescript_1.Column];
        ...
        Invoices = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Invoices = _classThis;
}();
