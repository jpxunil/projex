...
var CampaignSetting = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "CampaignSettings" })];
    ...
    var CampaignSetting = _classThis = /** @class */ (function (_super) {
        __extends(CampaignSetting_1, _super);
        function CampaignSetting_1() {
        ...
        return CampaignSetting_1;
    }(_classSuper));
    __setFunctionName(_classThis, "CampaignSetting");
    (function () {
        var _a;
        ...
        CampaignSetting = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CampaignSetting = _classThis;
}();
