...
var Chat = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "Chats" })];
    ...
    var Chat = _classThis = /** @class */ (function (_super) {
        ...
        function Chat_1() {
            ...
            _this.uuid = (__runInitializers(_this, _id_extraInitializers), __runInitializers(_this, _uuid_initializers, void 0));
            _this.title = (__runInitializers(_this, _uuid_extraInitializers), __runInitializers(_this, _title_initializers, void 0));
            _this.ownerId = (__runInitializers(_this, _title_extraInitializers), __runInitializers(_this, _ownerId_initializers, void 0));
            _this.lastMessage = (__runInitializers(_this, _ownerId_extraInitializers), __runInitializers(_this, _lastMessage_initializers, void 0));
            _this.companyId = (__runInitializers(_this, _lastMessage_extraInitializers), __runInitializers(_this, _companyId_initializers, void 0));
            ...
            _this.owner = (__runInitializers(_this, _company_extraInitializers), __runInitializers(_this, _owner_initializers, void 0));
            _this.users = (__runInitializers(_this, _owner_extraInitializers), __runInitializers(_this, _users_initializers, void 0));
            _this.messages = (__runInitializers(_this, _users_extraInitializers), __runInitializers(_this, _messages_initializers, void 0));
            __runInitializers(_this, _messages_extraInitializers);
            return _this;
        }
        Chat_1.setUUID = function (chat) {
    ...
    (function () {
        ...
        _title_decorators = [(0, sequelize_typescript_1.Column)({ defaultValue: "" })];
        _ownerId_decorators = [(0, sequelize_typescript_1.ForeignKey)(function () { return User_1.default; }), sequelize_typescript_1.Column];
        _lastMessage_decorators = [(0, sequelize_typescript_1.Column)({ defaultValue: "" })];
        ...
        _owner_decorators = [(0, sequelize_typescript_1.BelongsTo)(function () { return User_1.default; })];
        _users_decorators = [(0, sequelize_typescript_1.HasMany)(function () { return ChatUser_1.default; })];
        _messages_decorators = [(0, sequelize_typescript_1.HasMany)(function () { return ChatMessage_1.default; })];
