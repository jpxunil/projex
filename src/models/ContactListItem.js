...
var ContactListItem = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "ContactListItems" })];
    ...
    var _isWhatsappValid_decorators;
    var _isWhatsappValid_initializers = [];
    var _isWhatsappValid_extraInitializers = [];
    ...
    var ContactListItem = _classThis = /** @class */ (function (_super) {
        __extends(ContactListItem_1, _super);
        function ContactListItem_1() {
            ...
            _this.isWhatsappValid = (__runInitializers(_this, _email_extraInitializers), __runInitializers(_this, _isWhatsappValid_initializers, void 0));
            _this.createdAt = (__runInitializers(_this, _isWhatsappValid_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
            ...
            __runInitializers(_this, _contactList_extraInitializers);
            return _this;
        }
        return ContactListItem_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ContactListItem");
    (function () {
        var _a;
        ...
        _number_decorators = [(0, sequelize_typescript_1.AllowNull)(false), sequelize_typescript_1.Column];
        ...
        _isWhatsappValid_decorators = [sequelize_typescript_1.Column];
        ...
        __esDecorate(null, null, _isWhatsappValid_decorators, { kind: "field", name: "isWhatsappValid", static: false, private: false, access: { has: function (obj) { return "isWhatsappValid" in obj; }, get: function (obj) { return obj.isWhatsappValid; }, set: function (obj, value) { obj.isWhatsappValid = value; } }, metadata: _metadata }, _isWhatsappValid_initializers, _isWhatsappValid_extraInitializers);
        ...
        ContactListItem = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ContactListItem = _classThis;
}();
