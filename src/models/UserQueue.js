...
var UserQueue = function () {
    ...
    var UserQueue = _classThis = /** @class */ (function (_super) {
        __extends(UserQueue_1, _super);
        function UserQueue_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.userId = __runInitializers(_this, _userId_initializers, void 0);
            _this.queueId = (__runInitializers(_this, _userId_extraInitializers), __runInitializers(_this, _queueId_initializers, void 0));
    ...
    __setFunctionName(_classThis, "UserQueue");
    (function () {
        var _a;
        ...
        UserQueue = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserQueue = _classThis;
}();
