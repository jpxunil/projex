...
var FilesOptions = function () {
    ...
    var FilesOptions = _classThis = /** @class */ (function (_super) {
        __extends(FilesOptions_1, _super);
        function FilesOptions_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.id = __runInitializers(_this, _id_initializers, void 0);
            _this.fileId = (__runInitializers(_this, _id_extraInitializers), __runInitializers(_this, _fileId_initializers, void 0));
            _this.name = (__runInitializers(_this, _fileId_extraInitializers), __runInitializers(_this, _name_initializers, void 0));
            _this.path = (__runInitializers(_this, _name_extraInitializers), __runInitializers(_this, _path_initializers, void 0));
            _this.mediaType = (__runInitializers(_this, _path_extraInitializers), __runInitializers(_this, _mediaType_initializers, void 0));
            _this.createdAt = (__runInitializers(_this, _mediaType_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
            ...
            _this.file = (__runInitializers(_this, _updatedAt_extraInitializers), __runInitializers(_this, _file_initializers, void 0));
            __runInitializers(_this, _file_extraInitializers);
            return _this;
        }
        return FilesOptions_1;
    }(_classSuper));
    __setFunctionName(_classThis, "FilesOptions");
    (function () {
        var _a;
        ...
        _fileId_decorators = [(0, sequelize_typescript_1.ForeignKey)(function () { return Files_1.default; }), sequelize_typescript_1.Column];
        _name_decorators = [sequelize_typescript_1.Column];
        _path_decorators = [sequelize_typescript_1.Column];
        _mediaType_decorators = [sequelize_typescript_1.Column];
        _createdAt_decorators = [sequelize_typescript_1.CreatedAt];
        _updatedAt_decorators = [sequelize_typescript_1.UpdatedAt];
        _file_decorators = [(0, sequelize_typescript_1.BelongsTo)(function () { return Files_1.default; })];
        ...
        FilesOptions = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FilesOptions = _classThis;
}();
