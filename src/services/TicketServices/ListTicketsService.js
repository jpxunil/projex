...
var ListTicketsService = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    var _s = _b.searchParam, searchParam = _s === void 0 ? "" : _s, _t = _b.pageNumber, pageNumber = _t === void 0 ? "1" : _t, queueIds = _b.queueIds, tags = _b.tags, users = _b.users, status = _b.status, date = _b.date, updatedAt = _b.updatedAt, showAll = _b.showAll, userId = _b.userId, withUnreadMessages = _b.withUnreadMessages, companyId = _b.companyId;
        ...
        switch (_u.label) {
            case 0:
                ...
                if (searchParam) {
                    ...
                    whereCondition = __assign(__assign({}, whereCondition), (_h = {}, _h[sequelize_1.Op.or] = [
                        {
                            "$contact.name$": (0, sequelize_1.where)((0, sequelize_1.fn)("LOWER", (0, sequelize_1.col)("contact.name")), "LIKE", "%".concat(sanitizedSearchParam, "%"))
                        },
                        { "$contact.number$": (_j = {}, _j[sequelize_1.Op.like] = "%".concat(sanitizedSearchParam, "%"), _j) },
                        {
                ...
                if (date) {
                    whereCondition = {
                        createdAt: (_k = {},
                            _k[sequelize_1.Op.between] = [+(0, date_fns_1.startOfDay)((0, date_fns_1.parseISO)(date)), +(0, date_fns_1.endOfDay)((0, date_fns_1.parseISO)(date))],
                            _k)
                    };
                }
                if (updatedAt) {
            ...
            case 1:
                ...
                whereCondition = (_m = {},
                    _m[sequelize_1.Op.or] = [{ userId: userId }, { status: "pending" }],
                    _m.queueId = (_o = {}, _o[sequelize_1.Op.or] = [userQueueIds, null], _o),
                    _m.unreadMessages = (_p = {}, _p[sequelize_1.Op.gt] = 0, _p),
                    _m);
                _u.label = 2;
            case 2:
            ...
            case 6:
                ...
                whereCondition = __assign(__assign({}, whereCondition), { id: (_q = {},
                        _q[sequelize_1.Op.in] = ticketsIntersection,
                        _q) });
                _u.label = 7;
            case 7:
            ...
            case 13:
                _d = _u.sent(), count = _d.count, tickets = _d.rows;
