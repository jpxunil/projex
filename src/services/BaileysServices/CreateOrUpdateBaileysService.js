...
var createOrUpdateBaileysService = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var baileysExists, getChats, getContacts, newBaileys, baileys;
    var whatsappId = _b.whatsappId, contacts = _b.contacts, chats = _b.chats;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                baileysExists = _c.sent();
                if (!baileysExists) return [3 /*break*/, 3];
                ...
                if (chats && (0, lodash_1.isArray)(getChats)) {
                    ...
                    getChats.sort();
                    getChats.filter(function (v, i, a) { return a.indexOf(v) === i; });
                }
                if (contacts && (0, lodash_1.isArray)(getContacts)) {
                    getContacts.push.apply(getContacts, contacts);
                    getContacts.sort();
                    getContacts.filter(function (v, i, a) { return a.indexOf(v) === i; });
                }
            ...
            case 2:
                newBaileys = _c.sent();
                return [2 /*return*/, newBaileys];
            case 3: return [4 /*yield*/, Baileys_1.default.create({
