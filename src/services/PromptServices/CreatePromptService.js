...
var CreatePromptService = function (promptData) { return __awaiter(void 0, void 0, void 0, function () {
    var name, apiKey, prompt, queueId, maxMessages, companyId, promptSchema, err_1, promptTable;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                name = promptData.name, apiKey = promptData.apiKey, prompt = promptData.prompt, queueId = promptData.queueId, maxMessages = promptData.maxMessages, companyId = promptData.companyId;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, promptSchema.validate({ name: name, apiKey: apiKey, prompt: prompt, queueId: queueId, maxMessages: maxMessages, companyId: companyId })];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
            ...
            case 4: return [4 /*yield*/, Prompt_1.default.create(promptData)];
            case 5:
                promptTable = _a.sent();
                return [4 /*yield*/, (0, ShowPromptService_1.default)({ promptId: promptTable.id, companyId: companyId })];
            case 6:
                promptTable = _a.sent();
