...
var ShowQueueService_1 = require("./ShowQueueService");
var UpdateQueueService = function (queueId, queueData, companyId) { return __awaiter(void 0, void 0, void 0, function () {
    var color, name, queueSchema, err_1, queue;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                color = queueData.color, name = queueData.name;
            ...
            case 5:
                ...
                return [4 /*yield*/, queue.update(queueData)];
            case 6:
                _a.sent();
