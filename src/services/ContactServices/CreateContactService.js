...
var CreateContactService = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var numberExists, contact;
    var name = _b.name, number = _b.number, _c = _b.email, email = _c === void 0 ? "" : _c, companyId = _b.companyId, _d = _b.extraInfo, extraInfo = _d === void 0 ? [] : _d;
