...
var UpdateSchedulesService = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var company;
    var id = _b.id, schedules = _b.schedules;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, Company_1.default.findByPk(id)];
            case 1:
                company = _c.sent();
                if (!company) {
