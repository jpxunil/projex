        ...
        switch (_g.label) {
            case 0:
                ...
                if (!(0, lodash_1.isEmpty)(searchParam)) {
                    whereCondition = __assign(__assign({}, whereCondition), (_d = {}, _d[sequelize_1.Op.or] = [
                        {
                            name: (0, sequelize_1.where)((0, sequelize_1.fn)("LOWER", (0, sequelize_1.col)("ContactList.name")), "LIKE", "%".concat(searchParam.toLowerCase().trim(), "%"))
                        }
                    ], _d));
                }
                limit = 20;
